...
const messages = {
  "zh-CN": {
    ...
    "sidebar.sync": "同步",
    "sidebar.wechatInput": "微信输入",
    "sidebar.dailyReview": "每日回顾",
    "sidebar.aiInsight": "AI 洞察",
    "sidebar.agent": "Agent",
    "sidebar.randomWalk": "随机漫步",
    "composer.ariaLabel": "新记录",
    "composer.placeholder": "现在的想法是...",
    "composer.addAttachment": "添加附件",
    "composer.addTag": "添加标签",
    "composer.formatText": "格式",
  ...
  "en-US": {
    ...
    "sidebar.sync": "Sync",
    "sidebar.wechatInput": "WeChat input",
    "sidebar.dailyReview": "Daily review",
    "sidebar.aiInsight": "AI insight",
    "sidebar.agent": "Agent",
    "sidebar.randomWalk": "Random walk",
